...
#                         pointing output-dir outside its own Quarto project
#                         directory is a genuinely broken configuration
#                         (confirmed by direct testing: scattered output
#                         across multiple locations, a recurring typst
#                         "file not found" bug, and a docx-corruption
#                         regression), not just an unusual one. See
...
#                         manuscript/output/, since Quarto's website render
#                         deletes anything under its own output-dir that it
#                         doesn't recognize as its own output.
required_dirs <- c(
  "R",
